...
function ModalPortfolioFiles(props: {
    show: boolean,
    ...
    return (
        ...
        >
            <div role="alert" className="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                ...
                <div
                    className="relative p-4 md:p-8 bg-white dark:bg-gray-800 dark:border-gray-700 shadow-md rounded border border-gray-400">
                    <div className="w-full flex justify-center text-gray-600 dark:text-gray-400 mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-upload"
                             width={56}
                             height={56} viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" fill="none"
                    ...
                    <h1 className="text-center text-gray-800 dark:text-gray-100 font-lg font-bold tracking-normal leading-tight mb-4">Upload
                        Files</h1>
                    <p className="mb-5 text-sm text-gray-600 dark:text-gray-400 text-center font-normal">Attach files
                        for
                        portfolio</p>
                    <div
                    ...
                    <div className="flex justify-between items-center w-full">
                        <div className="items-center text-gray-600 dark:text-gray-400 flex">
                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-file"
                                 width={24}
                            ...
                            <p className="text-gray-800 dark:text-gray-100 font-normal text-base tracking-normal ml-2 mr-4">CV.pdf</p>
                    ...
                    <div className="flex items-center justify-center w-full gap-x-3">
                        ...
                        <button
                            className="focus:outline-none bg-gray-100 dark:bg-gray-700 dark:border-gray-700 dark:hover:bg-gray-600 transition duration-150 text-gray-600 dark:text-gray-400 ease-in-out hover:border-gray-400 hover:bg-gray-300 border rounded px-8 py-2 text-sm"
...
export default ModalPortfolioFiles;