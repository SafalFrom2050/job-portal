...
const Heading = (props: { heading: string, count?: number, sort?: boolean, cClass?: string, hClass?: string, showBackButton?: boolean, backButtonAction?: () => void }) => {
    ...
    return (
        <div
            className={overrideTailwindClasses(`mx-auto pb-4 pt-8 px-4 2xl:mx-auto flex justify-center items-center max-w-[1000px] ${props.cClass}`)}>
            <div className="flex justify-between items-center w-full">
                ...
                {props.sort && <>
                    <div
                        className="w-40 sm:w-fit mt-4 sm:mt-0 py-3 px-4 flex items-center text-sm font-medium leading-none text-gray-600 bg-white hover:bg-gray-50 cursor-pointer rounded">
