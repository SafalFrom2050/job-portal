...
const Heading = (props: {heading: string, count?:number}) => {
    return (
        <div className={overrideTailwindClasses(`mx-auto pb-4 pt-8 px-4 2xl:mx-auto flex justify-center items-center max-w-[800px]`)}>
            <div className="flex justify-between items-center w-full">
                ...
                <button className="hover:text-gray-500 text-gray-600 bg-white py-3.5 px-3 rounded-sm flex flex-row justify-center items-center space-x-3">
