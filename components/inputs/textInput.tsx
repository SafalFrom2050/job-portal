        ...
        <div>
            ...
            <div className={`flex items-end gap-2 ${props.cClass}`}>
                ...
                <input
                    ...
                    type={props.type}
                    className={overrideTailwindClasses(`bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-400 placeholder:text-sm text-gray-800 py-2 w-full pl-3 mt-2 ${props.iClass} ${props.error? "bg-red-50 border-red-400" : ""}`)}
