...
export function TopReview() {
    return <div className="xl:w-1/3 md:w-1/2 lg:ml-16 ml-8 md:mt-0 mt-6">
        ...
        <div className="flex items-start mt-8">
            ...
            <p className="sm:text-2xl text-xl leading-7 text-gray-600 pl-2.5">Found my dream job within 3 days of
                signing up. I highly recommend anyone to try this app.</p>
        </div>
        <div className="flex items-center pl-8 mt-10">
            ...
            <div className="ml-2">
                <p className="text-sm font-medium leading-none text-gray-800">Safal Sharma</p>
            </div>
        </div>
    </div>;
}