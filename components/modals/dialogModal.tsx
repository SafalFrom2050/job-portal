...
const DialogModal = (props: {
    ...
    return (
        <form>
            {show && <div
                className="py-12 flex items-center bg-gray-50 bg-opacity-50 transition duration-150 ease-in-out z-50 fixed top-0 right-0 bottom-0 left-0"
                id="modal">
                <div role="alert" className="container mx-auto w-fit max-w-lg">
                    <div
                        ...
                        <div className="flex items-center justify-center w-full">
                            ...
                            <PrimaryButton isSubmitType={false}
                                           ...
                                           class={`text-sm font-medium ${props.buttonRightClass}`}
