...
function BottomNav() {
    ...
    return (
        <div>
            <div
                className={"w-full fixed bottom-0 z-30 bg-gray-800 shadow md:h-full flex-col justify-between md:hidden transition duration-150 ease-in-out transform -translate-x-0"}
                id="mobile-nav">
