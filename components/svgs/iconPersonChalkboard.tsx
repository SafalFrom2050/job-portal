...
function IconPersonChalkboard(props: {className?: string, color: string}) {
    return (
        <div className={overrideTailwindClasses(`w-8 h-8 flex items-center ${props.className}`)}>
...
export default IconPersonChalkboard;