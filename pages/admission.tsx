...
function Admission() {
    ...
    const {data, isLoading} = useQuery("posts_with_type_admission: ", () => searchPosts(axiosInstance, {position: "2"}), {enabled: !!axiosInstance})
    ...
    return (
        <main className={"container mx-auto max-w-[1000px]"}>
            ...
            <Heading heading={"Admission Jobs"} count={posts ? posts.length : 0} sort={true} cClass={"sticky top-0 bg-indigo-50"} />
