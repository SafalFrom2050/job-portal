...
function Intern() {
    ...
    const {data, isLoading} = useQuery("posts_with_type_intern: ", () => searchPosts(axiosInstance, {position: "4"}), {enabled: !!axiosInstance})
    ...
    return (
        <main className={"container mx-auto max-w-[1000px]"}>
            ...
            <Heading heading={"Internships"} count={posts ? posts.length : 0} sort={true} cClass={"sticky top-0 bg-indigo-50"} />
