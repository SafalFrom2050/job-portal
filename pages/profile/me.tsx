                ...
                <div className="bg-white dark:bg-gray-800 shadow rounded">
                    <div className="relative">
                        ...
                        <div className="inset-0 m-auto w-24 h-24 absolute bottom-0 -mb-12 rounded border-2 shadow border-white">
                            <img className="w-full h-full overflow-hidden object-cover rounded" src={user.avatar || "/images/default-profile.jpeg"} />
                        </div>
                    </div>
                    <div className="px-5 pb-10">
                        ...
                        <div className="pt-3 flex flex-col items-center justify-between ">
                            <div className=" w-full xl:w-2/3">
                                ...
                                <p className="text-center mt-2 text-sm tracking-normal text-gray-600 dark:text-gray-400 leading-5">HI, I am a developer interested in frontend technologies such as React, Angular. I have a past experience with Laravel, Nextjs, Java Swing, React Native and Android Development. To know more about me, please check out my CV.</p>
                            </div>
                            ...
                            <div className="w-full flex-col md:flex-row justify-center flex">
                                <div className="flex items-center justify-center mt-1 md:mt-0 mb-5 md:mb-0 ">
                                    <div className="rounded-full bg-green-200 text-green-500 text-sm px-6 py-2 flex justify-center items-center">Available</div>
                                </div>
                                <button className="focus:outline-none ml-0 md:ml-5 bg-indigo-700 dark:bg-indigo-600 transition duration-150 ease-in-out hover:bg-indigo-600 rounded-full text-white px-3 md:px-6 py-2 text-sm">Contact Me</button>
                            </div>
                        </div>
                    </div>
                </div>
